...
export const floridaBusinessForSale: ResearchTemplate<FloridaBusinessParams> = {
  ...
  i18n: {
    ...
    fr: {
      ...
      fields: {
        industry: { help: 'Type d’entreprise à rechercher. Choisissez une suggestion ou saisissez la vôtre.', placeholder: 'ex. Laveries' },
        location: { help: 'Zone géographique ciblée en Floride.', placeholder: 'ex. Comté de Miami-Dade, FL' },
        mode: { help: 'Essentiel = environ la moitié du coût, sections clés. Complet = rapport long et détaillé.' },
        language: { help: 'Langue de rédaction du rapport final.' },
        askingPriceMin: { help: 'Prix de vente minimum (USD). Laissez vide pour aucun plancher.' },
        askingPriceMax: { help: 'Prix de vente maximum (USD). Laissez vide pour aucun plafond.' },
        minRevenue: { help: 'Chiffre d’affaires annuel minimum (USD).' },
        minCashFlow: { help: 'Flux de trésorerie annuel minimum / SDE (USD).' },
        sbaFriendly: { help: 'Prioriser les opérations éligibles au financement SBA 7(a).' },
        includeRealEstate: { help: 'Préférer les opérations incluant l’immobilier commercial.' },
        keywords: { help: 'Mots-clés supplémentaires pour orienter la recherche.' },
        preferredSources: { help: 'Places de marché / courtiers à prioriser (en plus de ceux par défaut).' },
        instructions: { help: 'Ce que les options ci-dessus ne couvrent pas. C’est une orientation : cela ne change pas le contenu du rapport.' },
      },
      agentLabels: {
        ...
        'chart-refiner': { label: 'Affinage des graphiques', description: 'Améliore et complète les graphiques lors de la passe d’affinage.' },
    ...
    pt: {
      ...
      fields: {
        industry: { help: 'Tipo de negócio a buscar. Escolha uma sugestão ou escreva o seu.', placeholder: 'ex. Lavanderias' },
        location: { help: 'Foco geográfico dentro da Flórida.', placeholder: 'ex. Condado de Miami-Dade, FL' },
        mode: { help: 'Essencial = ~metade do custo, seções principais. Completo = relatório longo e detalhado.' },
        language: { help: 'Idioma em que o relatório final é escrito.' },
        askingPriceMin: { help: 'Preço de venda mínimo (USD). Deixe em branco para sem piso.' },
        askingPriceMax: { help: 'Preço de venda máximo (USD). Deixe em branco para sem teto.' },
        minRevenue: { help: 'Receita anual mínima (USD).' },
        minCashFlow: { help: 'Fluxo de caixa anual mínimo / SDE (USD).' },
        sbaFriendly: { help: 'Priorizar operações elegíveis a financiamento SBA 7(a).' },
        includeRealEstate: { help: 'Preferir operações que incluam imóvel comercial.' },
        keywords: { help: 'Palavras-chave adicionais para orientar a busca.' },
        preferredSources: { help: 'Marketplaces/corretores a priorizar (além dos padrão).' },
        instructions: { help: 'O que as opções acima não cobrem. É orientação: não muda o conteúdo do relatório.' },
      },
      agentLabels: {
        ...
        'chart-refiner': { label: 'Refinamento de gráficos', description: 'Melhora e completa os gráficos na passagem de refinamento.' },
