    ...
    <div className="stack" style={{ gap: 22 }}>
      ...
      {job.status === 'completed' && report.data && (
        <>
          ...
          <ReportViewer currency={template.data?.currency} cover={template.data?.cover} report={report.data.report} sections={template.data?.sections} title={job.title ?? undefined} lang={reportLang} meta={report.data.meta} request={requestCtx} />
        </>
      )}
