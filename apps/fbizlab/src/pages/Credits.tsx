...
const T = {
  en: {
    ...
    creditsLbl: 'Credits', perCredit: '/ credit', oneTime: 'One-time payment. Credits valid for one year.',
    ...
    q1: 'Do credits expire?', a1: 'Yes — credits expire one year after purchase; unused credits are removed after that.',
  ...
  es: {
    ...
    sub: 'Los créditos pagan tus dossiers de research con IA. Compra una vez — tus créditos son válidos por un año desde la compra, y siempre ves el costo exacto de un dossier antes de confirmar.',
    currentBalance: 'Saldo actual', creditsAvailable: 'créditos disponibles',
    creditsLbl: 'Créditos', perCredit: '/ crédito', oneTime: 'Pago único. Créditos válidos por un año.',
    ...
    q1: '¿Los créditos expiran?', a1: 'Sí — los créditos expiran un año después de la compra; los créditos no usados se eliminan después.',
  ...
  fr: {
    ...
    sub: 'Les crédits paient vos dossiers de research IA. Achetez une fois — vos crédits sont valables un an à compter de l’achat, et vous voyez toujours le coût exact d’un dossier avant de confirmer.',
    currentBalance: 'Solde actuel', creditsAvailable: 'crédits disponibles',
    creditsLbl: 'Crédits', perCredit: '/ crédit', oneTime: 'Paiement unique. Crédits valables un an.',
    ...
    q1: 'Les crédits expirent-ils ?', a1: 'Oui — les crédits expirent un an après l’achat ; les crédits non utilisés sont ensuite supprimés.',
  ...
  pt: {
    ...
    sub: 'Os créditos pagam seus dossiês de research com IA. Compre uma vez — seus créditos são válidos por um ano a partir da compra, e você sempre vê o custo exato de um dossiê antes de confirmar.',
    currentBalance: 'Saldo atual', creditsAvailable: 'créditos disponíveis',
    creditsLbl: 'Créditos', perCredit: '/ crédito', oneTime: 'Pagamento único. Créditos válidos por um ano.',
    ...
    q1: 'Os créditos expiram?', a1: 'Sim — os créditos expiram um ano após a compra; créditos não usados são removidos depois.',
