...
const T = {
  en: {
    ...
    sub: 'Credits pay for your AI research dossiers. Buy once — your credits never expire, and you always see a report’s exact cost before you confirm.',
    ...
    q2: 'How many credits does a report cost?',
    a2: 'An essential report costs {e} credits; a comprehensive dossier costs {c}. You always see the exact cost before you confirm.',
    a2f: 'Each report shows its exact credit cost before you confirm — a comprehensive dossier costs more than an essential one.',
    q3: 'When is my report ready?', a3: 'Reports are generated in about 2–8 minutes and appear in your dashboard — open one to read the full dossier.',
  },
  es: {
    eyebrow: 'Créditos', title: 'Recarga tu saldo',
    sub: 'Los créditos pagan tus dossiers de research con IA. Compra una vez — tus créditos no expiran, y siempre ves el costo exacto de un reporte antes de confirmar.',
    ...
    q2: '¿Cuántos créditos cuesta un reporte?',
    a2: 'Un reporte essential cuesta {e} créditos; un dossier comprehensive cuesta {c}. Siempre ves el costo exacto antes de confirmar.',
    a2f: 'Cada reporte muestra su costo exacto en créditos antes de confirmar — un dossier comprehensive cuesta más que uno essential.',
    q3: '¿Cuándo está listo mi reporte?', a3: 'Los reportes se generan en unos 2–8 minutos y aparecen en tu panel — ábrelo para leer el dossier completo.',
  },
  fr: {
    eyebrow: 'Crédits', title: 'Rechargez votre solde',
    sub: 'Les crédits paient vos dossiers de research IA. Achetez une fois — vos crédits n’expirent pas, et vous voyez toujours le coût exact d’un rapport avant de confirmer.',
    ...
    q2: 'Combien de crédits coûte un rapport ?',
    a2: 'Un rapport essential coûte {e} crédits ; un dossier comprehensive coûte {c}. Vous voyez toujours le coût exact avant de confirmer.',
    a2f: 'Chaque rapport affiche son coût exact en crédits avant confirmation — un dossier comprehensive coûte plus qu’un essential.',
    q3: 'Quand mon rapport est-il prêt ?', a3: 'Les rapports sont générés en 2–8 minutes environ et apparaissent dans votre tableau de bord — ouvrez-en un pour lire le dossier complet.',
  },
  pt: {
    eyebrow: 'Créditos', title: 'Recarregue seu saldo',
    sub: 'Os créditos pagam seus dossiês de research com IA. Compre uma vez — seus créditos não expiram, e você sempre vê o custo exato de um relatório antes de confirmar.',
    ...
    q2: 'Quantos créditos custa um relatório?',
    a2: 'Um relatório essential custa {e} créditos; um dossiê comprehensive custa {c}. Você sempre vê o custo exato antes de confirmar.',
    a2f: 'Cada relatório mostra seu custo exato em créditos antes de confirmar — um dossiê comprehensive custa mais que um essential.',
    q3: 'Quando meu relatório fica pronto?', a3: 'Os relatórios são gerados em cerca de 2–8 minutos e aparecem no seu painel — abra um para ler o dossiê completo.',
  },
};
